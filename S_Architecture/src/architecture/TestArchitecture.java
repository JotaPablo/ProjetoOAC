...
//		end
	...
	public void testFillCommandsList() {
		...
		assertTrue("jmp".equals(commands.get(8)));        // 8
		assertTrue("jz".equals(commands.get(9)));         // 9
		assertTrue("jn".equals(commands.get(10)));         // 10
		assertTrue("read".equals(commands.get(11)));       // 11
