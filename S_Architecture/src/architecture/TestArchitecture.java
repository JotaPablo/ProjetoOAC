...
//		end
	...
	public void testFillCommandsList() {
		...
		assertTrue("jmp".equals(commands.get(5)));        // 8
		assertTrue("jn".equals(commands.get(6)));         // 9
		assertTrue("jz".equals(commands.get(7)));         // 10
        assertTrue("jeq".equals(commands.get(8)));        // 11
		assertTrue("read".equals(commands.get(8)));       // 12
		assertTrue("store".equals(commands.get(9)));      // 13
		assertTrue("ldi".equals(commands.get(10)));       // 14
		assertTrue("inc".equals(commands.get(11)));       // 15
		assertTrue("moveRegReg".equals(commands.get(12))); // 16
	}
